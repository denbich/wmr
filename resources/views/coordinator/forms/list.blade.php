            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active"><a href="{{ route('c.form.list') }}">Lista</a></li>
                </ol>
              </nav>
            </div>
    ...
    <div class="container-fluid mt--6">
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-body">
                    <a class="btn btn-icon btn-primary mb-2" href="{{ route('c.form.archive') }}">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <span class="alert-text"><strong>Sukces!</strong> Formularz został usunięty pomyślnie!</span>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody class="list">
                                ...
                                @empty <h2 class="text-center text-danger">Brak wolontariuszy!</h2> @endforelse
                            </tbody>
                        </table>
                    </div>
