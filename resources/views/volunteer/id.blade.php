            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6 align-content-center">
                        @php
                            $code = substr(Auth::user()->firstname, 0, 1).substr(Auth::user()->lastname, 0, 1).date('dm', strtotime(Auth::user()->created_at)).Auth::user()->gender.date('dm', strtotime(Auth::user()->agreement_date)).Auth::id();
                        @endphp
