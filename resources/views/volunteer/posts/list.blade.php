          ...
          <div class="header-body">
            <div class="row align-items-center py-4">
              <div class="col-lg-6 col-7">
                <h6 class="h2 text-white d-inline-block mb-0">{{ __('volunteer.sidebar.posts') }}</h6>
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    <li class="breadcrumb-item"><a href="{{ route('v.dashboard') }}"><i class="fas fa-home"></i></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('v.post.list') }}">{{ __('volunteer.sidebar.posts') }}</a></li>
                  </ol>
                </nav>
              </div>
            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-4 h-100">
                    <a href="{{ route('v.post', [$post->id]) }}">
                        <div class="card">
                            ...
                            <h4><b>{{ __('volunteer.posts.list.read') }}...</b></h4>
                            <h4 class="text-muted">{{ __('volunteer.posts.author') }}: {{ $post->author->name }}</h4>
