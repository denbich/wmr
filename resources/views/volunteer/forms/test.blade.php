                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 mb-4 h-100">
                            <a href="{{ route('v.form.show', [$form->id]) }}">
                                <div class="card">
                                    ...
                                    <h4><i class="fas fa-clock"></i> {{ $form->expiration }}</h4>
                                    <h4 class="text-muted">
                                        @switch($form->signed_form->condition)
                                            ...
                                            {{ __('Zapisany') }}
                                                @break
                                            @case(1)
                                            {{ __('Przydzielone stanowisko') }}
                                            @break
                                            @case(2)
                                            <span class="text-success">{{ __('Potwierdzona obecność') }}</span>
                                            @break
                                            @case(3)
                                            <span class="text-danger">{{ __('Nieobecny/a') }}</span>
                                            @break
                                            @default
                                            {{ __('Niezapisany') }}
                                        @endswitch
